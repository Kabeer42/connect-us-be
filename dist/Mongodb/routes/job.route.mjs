...
jobRouter.post("/create-jobs", async (req, res) => {
    try {
        const { user_id, Job_title, Company, Workplace_type, Job_location, Job_type, description, Skills, languages, email_website, education, custom_question, comfort_location, hybrid_work, skills_level } = req.body;
...
//# sourceMappingURL=job.route.mjs.map